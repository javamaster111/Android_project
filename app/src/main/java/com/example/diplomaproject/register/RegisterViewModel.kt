...
class RegisterViewModel @Inject constructor(
    ...
    fun signUp(
        ...
        viewModelScope.launch {
            try {
                val (result, errorMessage) = userRepo.signUp(username, password, verificationCode)
                if (result != null) {
    ...
    fun sendEmailVerification(
        ...
        viewModelScope.launch {
            try {
                val (result, errorMessage) = userRepo.sendEmailVerification(username, smsRequestType)
                if (result != null) {
